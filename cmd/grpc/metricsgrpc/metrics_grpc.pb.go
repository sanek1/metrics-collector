...
type MetricsServiceClient interface {
	SendMetrics(ctx context.Context, in *MetricList, opts ...grpc.CallOption) (*Empty, error)
}
...
func (c *metricsServiceClient) SendMetrics(ctx context.Context, in *MetricList, opts ...grpc.CallOption) (*Empty, error) {
...
type MetricsServiceServer interface {
	SendMetrics(context.Context, *MetricList) (*Empty, error)
...
func (UnimplementedMetricsServiceServer) SendMetrics(context.Context, *MetricList) (*Empty, error) {
...
func _MetricsService_SendMetrics_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MetricsServiceServer).SendMetrics(ctx, req.(*MetricList))
	}
